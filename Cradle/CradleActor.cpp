...
void CradleActor::Update(BasicTimer* time)
{
	...
	// DirectX::XMMATRIX world = DirectX::XMMatrixIdentity() * DirectX::XMMatrixRotationRollPitchYaw(m_vRotation.x, m_vRotation.y, m_vRotation.z);
	
	DirectX::XMMATRIX world = DirectX::XMMatrixIdentity() * DirectX::XMMatrixScaling(m_vScale.x, m_vScale.y, m_vScale.z)
